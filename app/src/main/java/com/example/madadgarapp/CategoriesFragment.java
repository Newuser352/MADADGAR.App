...
public class CategoriesFragment extends Fragment {
    ...
    /**
     * Set up click listener for category selection card
     */
    ...
    private void showCategoryDialog() {
        ...
        // Set dialog reference to button tags for access in click listeners
    ...
    /**
     * Initialize dialog view references
     */
    ...
    /**
     * Set up click listeners for categories in the dialog
     */
     ...
     * @param isEmpty true if there are no categories to display
     */
